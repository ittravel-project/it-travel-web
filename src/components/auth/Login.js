      ...
      <div className="container mt-5 login-container">
        ...
        <div className="row justify-content-md-center">
          <div className="col-xs-12 col-sm-12 col-md-4 login">
              ...
              <hr />
              <a href="/authenticate/google/callback" className="btn btn-block btn-danger shadow"><i className="fa fa-google"></i>  Login with Google</a>
              <a href="/authenticate/facebook/callback" className="btn btn-block btn-primary shadow"><i className="fa fa-facebook-f"></i> Login with Facebook</a>
